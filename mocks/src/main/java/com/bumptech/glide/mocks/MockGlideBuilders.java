 ...
 * will default to returning the mock rather than null. Any method on the builder that returns anything other than the builder will return Mockito's standard default return value.
 */
