...
/**
 * Maintains a cache of data, resource, and transcode classes to available {@link com.bumptech.glide.load.engine.LoadPath}s capable of decoding with the requested types.
 */
