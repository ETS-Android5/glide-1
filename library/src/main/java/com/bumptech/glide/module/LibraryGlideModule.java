 ...
 * application conflict, {@link AppGlideModule}s can use the {@link com.bumptech.glide.annotation.Excludes} annotation to selectively remove one or more of the conflicting modules.
 */
