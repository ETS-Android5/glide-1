...
public class MediaStoreSignature implements Key {
     ...
     *
     * @param mimeType     The mime type of the media store media. Ok to default to empty string "". See {@link android.provider.MediaStore.Images.ImageColumns#MIME_TYPE} or {@link
     *                     android.provider.MediaStore.Video.VideoColumns#MIME_TYPE}.
     * @param dateModified The date modified time of the media store media. Ok to default to 0. See {@link android.provider.MediaStore.Images.ImageColumns#DATE_MODIFIED} or {@link
