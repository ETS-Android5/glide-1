...
public class Glide implements ComponentCallbacks2 {
    ...
    * Any {@link android.graphics.Bitmap} added to the pool must not be currently in use in any other part of the application. Any {@link android.graphics.Bitmap} added to the pool must
    * be removed from the pool before it is added a second time.
    *
