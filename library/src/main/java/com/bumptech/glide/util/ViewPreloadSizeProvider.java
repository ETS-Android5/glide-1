...
/**
 * A {@link com.bumptech.glide.ListPreloader.PreloadSizeProvider} that will extract the preload size from a given {@link android.view.View}.
 *
...
public class ViewPreloadSizeProvider<T>
     ...
     *
     * @param view A not null View the size will be extracted from async using an {@link android.view.ViewTreeObserver .OnPreDrawListener}
     */
    // Public API.
     ...
     * ignored.
     *
     * @param view A not null View the size will be extracted async with an {@link android.view.ViewTreeObserver .OnPreDrawListener}
     */
