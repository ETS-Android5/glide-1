...
/**
 * Uses the content length as the basis for the return value of {@link #available()} and verifies that at least content length bytes are returned from the various read methods.
 */
