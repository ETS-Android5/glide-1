...
public class ResourceDrawableDecoder implements ResourceDecoder<Uri, Drawable> {
   /**
    * The package name to provide {@link Resources#getIdentifier(String, String, String)} when trying to find system resource ids.
    *
    * <p>As far as I can tell this is undocumented, but works.
    */
   private static final String ANDROID_PACKAGE_NAME = "android";
   /**
    * {@link Resources#getIdentifier(String, String, String)} documents that it will return 0 and that 0 is not a valid resouce id.
    */
