...
public final class MemorySizeCalculator {
   ...
   /**
    * Constructs an {@link MemorySizeCalculator} with reasonable defaults that can be optionally overridden.
    */
   // Public API.
   ...
   public static final class Builder {
      ...
      /**
       * Sets the number of device screens worth of pixels the {@link com.bumptech.glide.load.engine.cache.MemoryCache} should be able to hold and returns this Builder.
       */
      ...
      /**
       * Sets the number of device screens worth of pixels the {@link com.bumptech.glide.load.engine.bitmap_recycle.BitmapPool} should be able to hold and returns this Builder.
       */
      ...
      /**
       * Sets the maximum percentage of the device's memory class for low ram devices that can be taken up by Glide's {@link com.bumptech.glide.load.engine.cache.MemoryCache} and {@link
       * com.bumptech.glide.load.engine.bitmap_recycle.BitmapPool} put together, and returns this builder.
       *
      ...
      /**
       * Sets the size in bytes of the {@link com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool} to use to store temporary arrays while decoding data and returns this builder.
       *
