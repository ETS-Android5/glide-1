...
public class GifDrawable extends Drawable
    ...
    *                            being loaded into).
    * @param targetFrameHeight   The desired height of the frames displayed by this drawable (the height of the view or {@link com.bumptech.glide.request.target.Target} this drawable is
    *                            being loaded into).
   ...
   /**
    * Returns the current frame index in the range 0..{@link #getFrameCount()} - 1, or -1 if no frame is displayed.
    */
   // Public API.
   @SuppressWarnings("WeakerAccess")
   ...
   /**
    * Register callback to listen to GifDrawable animation end event after specific loop count set by {@link GifDrawable#setLoopCount(int)}.
    *
