...
class DecodeJob<R>
    ...
    *
    * @param isRemovedFromQueue {@code true} if we've been removed from the queue and {@link #run} is neither in progress nor will ever be called again.
    */
   ...
   /**
    * Called when we've finished encoding (either because the encode process is complete, or because we don't have anything to encode).
    */
   ...
   /**
    * Allows transformed resources to be encoded after the transcoded result is already delivered to requestors.
    */
