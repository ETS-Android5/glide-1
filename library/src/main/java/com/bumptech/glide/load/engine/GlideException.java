...
public final class GlideException extends Exception {
    ...
    /**
     * Returns an {@link Exception} with a stack trace that includes where the request originated (if previously set via {@link #setOrigin(Exception)})
     *
     * <p>This is an experimental API that may be removed in the future.
     */
    @Nullable
     ...
     * provide a more succinct overview of why the exception occurred, although it does not include complete stack traces.
     */
