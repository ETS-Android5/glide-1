...
public class LruBitmapPool implements BitmapPool {
     ...
     *
     * @param maxSize        The initial maximum size of the pool in bytes.
     * @param allowedConfigs A white listed put of {@link android.graphics.Bitmap.Config} that are allowed to be put into the pool. Configs not in the allowed put will be rejected.
     */
    // Public API.
