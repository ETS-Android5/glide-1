...
public final class HardwareConfigState {
    ...
    /**
     * The minimum size in pixels a {@link Bitmap} must be in both dimensions to be created with the {@link Bitmap.Config#HARDWARE} configuration.
     *
    ...
    /**
     * Each FD check takes 1-2ms, so to avoid overhead, only check every N decodes. 50 is more or less arbitrary.
     */
    private static final int MINIMUM_DECODES_BETWEEN_FD_CHECKS = 50;

    /**
     * 700 with an error of 50 Bitmaps in between at two FDs each lets us use up to 800 FDs for hardware Bitmaps.
     *
