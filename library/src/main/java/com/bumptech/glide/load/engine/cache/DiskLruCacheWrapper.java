...
public class DiskLruCacheWrapper implements DiskCache {
   ...
   /**
    * Get a DiskCache in the given directory and size. If a disk cache has already been created with a different directory and/or size, it will be returned instead and the new arguments
    * will be ignored.
    *
