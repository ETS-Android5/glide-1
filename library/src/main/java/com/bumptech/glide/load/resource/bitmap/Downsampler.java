...
/**
 * Downsamples, decodes, and rotates images according to their exif orientation using {@link BitmapFactory}.
 */
public final class Downsampler {
    ...
    /**
     * Identical to {@link #decode(InputStream, int, int, Options)}, except that it accepts a {@link ByteBuffer} in place of an {@link InputStream}.
     */
     ...
     * @param options         A set of options that may contain one or more supported options that influence how a Bitmap will be decoded from the given stream.
     * @param callbacks       A set of callbacks allowing callers to optionally respond to various significant events during the decode process.
