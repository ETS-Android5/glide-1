...
public abstract class DiskCacheStrategy {
   ...
   /**
    * Tries to intelligently choose a strategy based on the data source of the {@link com.bumptech.glide.load.data.DataFetcher} and the {@link com.bumptech.glide.load.EncodeStrategy} of
    * the {@link com.bumptech.glide.load.ResourceEncoder} (if an {@link com.bumptech.glide.load.ResourceEncoder} is available).
    */
    ...
    *
    * @param isFromAlternateCacheKey {@code true} if the resource we've decoded was loaded using an alternative, rather than the primary, cache key.
    * @param dataSource              Indicates where the data used to decode the resource was originally retrieved.
    * @param encodeStrategy          The {@link EncodeStrategy} the {@link com.bumptech.glide.load.ResourceEncoder} will use to encode the resource.
    */
