...
public final class LazyHeaders implements Headers {
   ...
   /**
    * Adds an {@link LazyHeaderFactory} that will be used to construct a value for the given key* lazily on a background thread.
    *
    * <p>This class is not thread safe.
    *
    * <p>This class may include default values for User-Agent and Accept-Encoding headers. These will
    * be replaced by calls to either {@link #setHeader(String, LazyHeaderFactory)} or {@link #addHeader(String, String)}, even though {@link #addHeader(String, LazyHeaderFactory)} would
   ...
   public static final class Builder {
      ...
      /**
       * Replaces all existing {@link LazyHeaderFactory LazyHeaderFactorys} for the given key with the given {@link LazyHeaderFactory}.
       *
