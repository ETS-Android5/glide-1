...
public interface Key {
   ...
   /**
    * For caching to work correctly, implementations <em>must</em> implement this method and {@link #hashCode()}.
    */
   @Override
   boolean equals(Object o);

   /**
    * For caching to work correctly, implementations <em>must</em> implement this method and {@link #equals(Object)}.
    */
   @Override
   int hashCode();
}
