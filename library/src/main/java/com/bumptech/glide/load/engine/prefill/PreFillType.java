...
/**
 * A container for a put of options used to pre-fill a {@link com.bumptech.glide.load.engine.bitmap_recycle.BitmapPool} with {@link Bitmap Bitmaps} of a single size and configuration.
 */
