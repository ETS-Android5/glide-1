...
/**
 * Handles generic {@link Drawable} types where we may be uncertain of their size or type and where we don't know that it's safe for us to recycle or re-use the Drawable.
 */
