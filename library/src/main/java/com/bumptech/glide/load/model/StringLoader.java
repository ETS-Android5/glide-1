...
/**
 * A model loader for handling certain string models. Handles paths, urls, and any uri string with a scheme handled by {@link android.content.ContentResolver#openInputStream(Uri)}.
 *
