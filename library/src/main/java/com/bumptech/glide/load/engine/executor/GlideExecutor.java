...
public final class GlideExecutor implements ExecutorService {
    ...
    /**
     * The default thread name prefix for executors from unlimited thread pool used to load/decode/transform data not found in cache.
     */
    ...
    /**
     * A strategy for handling unexpected and uncaught {@link Throwable}s thrown by futures run on the pool.
     */
    ...
    /**
     * A {@link java.util.concurrent.ThreadFactory} that builds threads slightly above priority {@link android.os.Process#THREAD_PRIORITY_BACKGROUND}.
     */
    ...
    public static final class Builder {
        /**
         * Prevents core and non-core threads from timing out ever if provided to {@link #setThreadTimeoutMillis(long)}.
         */
        ...
        /**
         * Sets the {@link UncaughtThrowableStrategy} to use for unexpected exceptions thrown by tasks on {@link GlideExecutor}s built by this {@code Builder}.
         */
        ...
        /**
         * Sets the prefix to use for each thread name created by any {@link GlideExecutor}s built by this {@code Builder}.
         */
