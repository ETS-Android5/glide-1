...
/**
 * Creates an {@link com.bumptech.glide.disklrucache.DiskLruCache} based disk cache in the specified disk cache directory.
 *
...
public class DiskLruCacheFactory implements DiskCache.Factory {
   ...
   /**
    * When using this constructor {@link CacheDirectoryGetter#getCacheDirectory()} will be called out of UI thread, allowing to do I/O access without performance impacts.
    *
