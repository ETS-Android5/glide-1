...
public interface BitmapPool {
   ...
   /**
    * Adds the given {@link android.graphics.Bitmap} if it is eligible to be re-used and the pool can fit it, or calls {@link Bitmap#recycle()} on the Bitmap and discards it.
    *
   ...
   /**
    * Returns a {@link android.graphics.Bitmap} of exactly the given width, height, and configuration, and containing only transparent pixels.
    *
    ...
    * @param height The height in pixels of the desired {@link android.graphics.Bitmap}.
    * @param config The {@link android.graphics.Bitmap.Config} of the desired {@link android.graphics.Bitmap}.
    * @return A {@link android.graphics.Bitmap} with exactly the given width, height, and config potentially containing random image data.
    ...
    *
    * @param level The level from {@link android.content.ComponentCallbacks2} to use to determine how many {@link android.graphics.Bitmap}s to evict.
