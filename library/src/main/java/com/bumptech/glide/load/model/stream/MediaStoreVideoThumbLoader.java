 ...
 * VideoDecoder#DEFAULT_FRAME}, this loader will always return {@code null}. The media store does not use a defined frame to generate the thumbnail, so we cannot accurately fulfill
