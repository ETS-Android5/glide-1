...
final class BitmapPreFillRunner implements Runnable {
   ...
   /**
    * The maximum number of millis we can run before posting. Set to match and detect the duration of non concurrent GCs.
    */
   ...
   /**
    * Attempts to allocate {@link android.graphics.Bitmap}s and returns {@code true} if there are more {@link android.graphics.Bitmap}s to allocate and {@code false} otherwise.
    */
   @VisibleForTesting
   boolean allocate() {
