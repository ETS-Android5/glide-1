...
/**
 * Handles http/https Uris by delegating to the {@link ModelLoader} for {@link com.bumptech.glide.load.model.GlideUrl GlideUrls}.
 *
...
public class UrlUriLoader<Data> implements ModelLoader<Uri, Data> {
    ...
    /**
     * Loads {@link java.io.InputStream InputStreams} from {@link android.net.Uri Uris} with http or https schemes.
     */
