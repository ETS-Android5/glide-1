...
/**
 * A wrapper resource that allows reference counting a wrapped {@link com.bumptech.glide.load.engine.Resource} interface.
 *
...
class EngineResource<Z> implements Resource<Z> {
    ...
    * done with the resource. Generally external users should never call this method, the framework will take care of this for you.
    */
