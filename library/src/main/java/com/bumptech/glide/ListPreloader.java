...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    public interface PreloadModelProvider<U> {
        ...
        /**
         * Returns a {@link List} of models that need to be loaded for the list to display adapter items in positions between {@code start} and {@code end}.
         *
         ...
         * in {@link #getPreloadRequestBuilder(Object)}. If that's not possible for any set of models, avoid including them in the {@link List} returned by this method.
         *
         * <p>Although it's acceptable for the returned {@link List} to contain {@code null} models,
         * it's best to filter them from the list instead of adding {@code null} to avoid unnecessary logic and expanding the size of the {@link List}
         *
         ...
         * trigger a {@link RuntimeException}. If you don't want to load a particular item or position, filter it from the list returned by {@link #getPreloadItems(int)}.
         *
    ...
    public interface PreloadSizeProvider<T> {
        ...
        /**
         * Returns the size of the view in the list where the resources will be displayed in pixels in the format [x, y], or {@code null} if no size is currently available.
         *
