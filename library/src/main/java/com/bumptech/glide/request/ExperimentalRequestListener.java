...
public abstract class ExperimentalRequestListener<ResourceT> implements RequestListener<ResourceT> {
     ...
     *
     * @param isAlternateCacheKey True if the data was obtained from the disk cache using an alternate cache key provided by a {@link com.bumptech.glide.load.model.ModelLoader} via
     *                            {@link com.bumptech.glide.load.model.ModelLoader.LoadData#alternateKeys}. Valid only if {@code dataSource} is {@link DataSource#DATA_DISK_CACHE} or
     *                            {@link DataSource#RESOURCE_DISK_CACHE}.
     */
