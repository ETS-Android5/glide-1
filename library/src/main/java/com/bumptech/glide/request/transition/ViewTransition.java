...
/**
 * A {@link Transition} that can apply a {@link android.view.animation.Animation Animation} to a {@link android.view.View View} using {@link android.view.View#startAnimation(android.view.animation.Animation)}.
 *
...
public class ViewTransition<R> implements Transition<R> {
    ...
    /**
     * Always clears the current animation on the view using {@link android.view.View#clearAnimation()}, then starts the {@link android.view.animation.Animation} given in the constructor using {@link android.view.View#startAnimation(android.view.animation.Animation)} and then returns {@code false}
