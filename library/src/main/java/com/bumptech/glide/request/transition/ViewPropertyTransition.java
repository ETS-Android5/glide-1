...
public class ViewPropertyTransition<R> implements Transition<R> {
   ...
   /**
    * Constructor for a view property animation that takes an {@link ViewPropertyTransition.Animator} interface that can apply a transition to a view.
    *
   ...
   /**
    * Always applies the {@link ViewPropertyTransition.Animator} given in the constructor to the given view and returns {@code false} because the animator cannot put the new resource on
    * the view.
    *
