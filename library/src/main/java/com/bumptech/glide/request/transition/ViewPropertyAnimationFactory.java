...
public class ViewPropertyAnimationFactory<R> implements TransitionFactory<R> {
    ...
    /**
     * Returns a new {@link Transition} for the given arguments. If isMemoryCache is {@code true} or isFirstImage is {@code false}, returns a {@link NoTransition} and otherwise returns
     * a new {@link ViewPropertyTransition} for the {@link ViewPropertyTransition.Animator} provided in the constructor.
     */
    @Override
