...
public interface Request {
    ...
    * of a request. For example if a Request has both a thumbnail and a primary request and the thumbnail portion of the request is complete, this method allows only the primary portion
    * of the request to be paused without clearing the previously completed thumbnail portion.
    */
   void pause();
