...
public class DrawableCrossFadeTransition implements Transition<Drawable> {
    ...
    *                           put.
    * @param isCrossFadeEnabled If {@code true}, animates the previous resource's alpha to 0 while animating the new resource's alpha to 100. Otherwise, only animates the new resource's
    *                           alpha to 100 while leaving the previous resource's alpha at 100. See {@link TransitionDrawable#setCrossFadeEnabled(boolean)}.
    */
   // Public API.
