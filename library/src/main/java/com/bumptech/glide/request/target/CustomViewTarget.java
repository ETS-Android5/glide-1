...
public abstract class CustomViewTarget<T extends View, Z> implements Target<Z> {
    ...
    * Transition)} is no longer used before redrawing the container (usually a View) or changing its visibility. <b>Not doing so will result in crashes in your app.</b>
    *
