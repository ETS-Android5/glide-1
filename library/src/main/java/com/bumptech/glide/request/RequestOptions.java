...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
    ...
    /**
     * Returns a {@link RequestOptions} object with {@link BaseRequestOptions#priority(Priority)}} set.
     */
    @SuppressWarnings("WeakerAccess") // Public API
    @NonNull
    @CheckResult
    ...
    /**
     * Returns a {@link RequestOptions} with {@link #override(int, int)} set where both the width and height are the given size.
     */
    @SuppressWarnings("WeakerAccess") // Public API
    @NonNull
    @CheckResult
