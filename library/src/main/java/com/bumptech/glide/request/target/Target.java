...
public interface Target<R> extends LifecycleListener {
     ...
     * Loads can be paused and restarted due to lifecycle or connectivity events and each restart may cause a call here.
     *
     ...
     * Transition)} is no longer used before redrawing the container (usually a View) or changing its visibility.
     *
    ...
    /**
     * A <b>mandatory</b> lifecycle callback that is called when a load is cancelled and its resources are freed.
     *
     * <p>You <b>must</b> ensure that any current Drawable received in {@link #onResourceReady(Object,
     * Transition)} is no longer used before redrawing the container (usually a View) or changing its visibility.
     *
