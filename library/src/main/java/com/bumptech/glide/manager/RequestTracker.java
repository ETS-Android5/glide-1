...
public class RequestTracker {
    ...
    /**
     * Stops tracking the given request, clears, and recycles it, and returns {@code true} if the request was removed or invalid or {@code false} if the request was not found.
     */
