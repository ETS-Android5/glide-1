...
/**
 * A view-less {@link android.app.Fragment} used to safely store an {@link com.bumptech.glide.RequestManager} that can be used to start, stop and manage Glide requests started for
 * targets the fragment or activity this fragment is a child of.
 *
...
public class RequestManagerFragment extends Fragment {
    ...
    /**
     * Sets a hint for which fragment is our parent which allows the fragment to return correct information about its parents before pending fragment transactions have been executed.
     */
