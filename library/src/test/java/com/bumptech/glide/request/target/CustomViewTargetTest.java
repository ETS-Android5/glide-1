 ...
 * class referenced in {@link CustomViewTarget} can't be found. This should be fixable with some gradle changes, but I've so far failed to figure out the right set of commands.
 */
