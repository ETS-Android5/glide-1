...
public class RequestOptionsTest {
    ...
    /**
     * Verifies that we set the flags for placeholder id correctly when applying a placeholder id via another RequestOptions.
     */
    @Test
    ...
    /**
     * Verifies that we set the flags for placeholder correctly when applying a placeholder via another RequestOptions.
     */
    @Test
    ...
    /**
     * Verifies that we set the flags for fallback correctly when applying a fallback via another RequestOptions.
     */
    @Test
    ...
    /**
     * Verifies that we set the flags for fallback id correctly when applying a fallback id via another RequestOptions.
     */
    @Test
    ...
    /**
     * Verifies that we set the flags for error correctly when applying an error via another RequestOptions.
     */
    @Test
    ...
    /**
     * Verifies that we set the flags for error id correctly when applying a fallback id via another RequestOptions.
     */
    @Test
