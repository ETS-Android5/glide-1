...
public class Util {
    ...
    /**
     * Gives the proper generic type to the {@link ArgumentCaptor}. Only useful when the captor's {@code T} is also a generic type. Without this it's really ugly to have a properly typed captor object.
     */
