...
/**
 * Runs some tests based on a random seed that asserts the output of writing to our buffered stream matches the output of writing to {@link java.io.ByteArrayOutputStream}.
 */
