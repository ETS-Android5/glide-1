...
public @interface GlideModule {
    /**
     * Returns the name of the class that will be used as a replacement for {@code com.bumptech.glide.Glide} in Applications that depend on Glide's generated code.
     */
