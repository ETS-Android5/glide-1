...
/**
 * Generates method overrides for classes that want to mix in {@link GlideOption} annotated methods in Glide extensions.
 */
final class RequestOptionsExtensionGenerator {
    ...
    /**
     * Returns the set of {@link GlideOption} annotated methods in the classes that correspond to the given extension class names.
     */
    ...
    /**
     * Returns a list containing an override {@link MethodSpec} for all {@link GlideOption} annotated methods in the classes that correspond to the given extension class names.
     */
