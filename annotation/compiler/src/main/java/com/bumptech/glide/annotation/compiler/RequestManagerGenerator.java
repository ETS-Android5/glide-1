...
/**
 * Generates an implementation of {@code com.bumptech.glide.RequestManager} that contains generated methods from {@link GlideExtension}s and {@link GlideType}.
 *
...
final class RequestManagerGenerator {
   ...
   /**
    * Generates overrides of existing RequestManager methods so that they return our generated RequestBuilder subtype.
    */
   ...
   /**
    * The {@code RequestOptions} subclass should always be our generated subclass type to avoid inadvertent errors where a different subclass is applied that accidentally wipes out some
    * logic in overidden methods in our generated subclass.
    */
   @Nullable
