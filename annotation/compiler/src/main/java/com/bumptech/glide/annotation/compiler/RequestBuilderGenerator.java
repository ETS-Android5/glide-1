...
final class RequestBuilderGenerator {
    ...
    /**
     * An arbitrary name of the Generic type in the generated RequestBuilder. e.g. RequestBuilder<TranscodeType>
     */
    ...
    /**
     * Returns {@code true} if the given {@link MethodSpec} is a useful method to have in our {@code com.bumptech.glide.RequestBuilder} subclass.
     *
     * <p>Only newly generated methods will be included in the generated {@code
     * com.bumptech.glide.request.BaseRequestBuilder} subclass, so we only have to filter out methods that override other methods to avoid duplicates.
     */
    ...
    /**
     * Generates a particular method with an equivalent name and arguments to the given method from the generated {@code com.bumptech.glide.request.BaseRequestBuilder} subclass.
     */
    ...
    /**
     * Overrides the protected downloadOnly method in {@code com.bumptech.glide.RequestBuilder} to return our generated subclass instead.
     */
