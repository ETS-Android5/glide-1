...
public final class Util {
    ...
    /**
     * Hardcoded file separator to workaround {@code JavaFileObjects.forResource(...)} defaulting to the unix one.
     */
    ...
    /**
     * Returns the {@code String} from a system property that is expected to contain the project directory for the module containing these tests or {@code null} if we're not currently attempting to regenerate test resources.
     */
