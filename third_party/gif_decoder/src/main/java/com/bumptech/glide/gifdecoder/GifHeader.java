...
/**
 * A header object containing the number of frames in an animated GIF image as well as basic metadata like width and height that can be used to decode each individual frame of the GIF. Can be shared by one or more {@link com.bumptech.glide.gifdecoder.GifDecoder}s to play the same animated GIF in
 * multiple views.
 *
...
public class GifHeader {
    ...
    boolean gctFlag;
    /**
     * Size of Global Color Table. The value is already computed to be a regular number, this field doesn't store the exponent.
     */
    int gctSize;
    /**
