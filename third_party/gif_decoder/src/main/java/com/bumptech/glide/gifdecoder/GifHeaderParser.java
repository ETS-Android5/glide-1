...
/**
 * A class responsible for creating {@link com.bumptech.glide.gifdecoder.GifHeader}s from data representing animated GIFs.
 *
...
public class GifHeaderParser {
    ...
    * field is used to calculate the number of bytes contained in the Global Color Table. To determine that actual size of the color table, raise 2 to [the value of the field + 1]. Even
    * if there is no Global Color Table specified, set this field according to the above formula so that decoders can choose the best graphics mode to display the stream in.</i></p>
    */
   ...
   /**
    * The default frame delay in hundredths of a second. This is used for GIFs with frame delays less than the minimum.
    */
