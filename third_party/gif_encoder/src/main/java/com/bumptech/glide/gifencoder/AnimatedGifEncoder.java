...
public class AnimatedGifEncoder {
    ...
    * Invoking <code>finish()</code> flushes all frames. If <code>setSize</code> was invoked, the size is used for all subsequent frames. Otherwise, the actual size of the image is used
    * for each frame.
    * <p>
    * See page 11 of http://giflib.sourceforge.net/gif89.txt for the position of the frame
    *
    * @param im BufferedImage containing frame to write.
    * @param x  Column number, in pixels, of the left edge of the image, with respect to the left edge of the Logical Screen.
    * @param y  Row number, in pixels, of the top edge of the image with respect to the top edge of the Logical Screen.
    * @return true if successful.
    */
