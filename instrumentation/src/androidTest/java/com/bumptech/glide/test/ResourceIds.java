...
/**
 * Internally in google we don't appear to be able to reference resource ids directly, this class is a hack around that until we figure out what's going wrong.
 */
