...
public class DrawableTransformationTest {
    ...
    /**
     * Transformations that produce a different output color/shape/image etc will end up returning a {@link Bitmap} based on the original {@link Drawable} but with the transformation applied.
     */
    @Test
